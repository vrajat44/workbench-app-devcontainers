...
# ── Sensitivity Value Set ────────────────────────────────────────────────────

SENSITIVITY_SYSTEM = "urn:verily:sensitivity"

SENSITIVITY_CODES: dict[str, dict[str, str]] = {
    "P_PNAME":         {"display": "Patient Name",                      "definition": "The full or partial name of a person."},
    "P_STREETADDR":    {"display": "Patient Street Address",            "definition": "A street address, including address lines 1 and 2."},
    "P_GEOREGION":     {"display": "Patient Geographic Region",         "definition": "Geographic subdivisions smaller than a state, including ZIP/Postal codes."},
    ...
    "P_AGE":           {"display": "Patient Age",                       "definition": "A patient's age, especially ages over 89 (PHI under Safe Harbor)."},
    "P_PHONE":         {"display": "Patient Phone Number",              "definition": "A telephone number."},
    "P_FAX":           {"display": "Patient Fax Number",                "definition": "A fax number."},
    ...
    "P_HPBN":          {"display": "Patient Health Plan Beneficiary #", "definition": "A health plan beneficiary number."},
    "P_ACCOUNTNUM":    {"display": "Patient Account Number",            "definition": "A financial account number."},
    "P_CERT":          {"display": "Patient Certificate/License #",     "definition": "A certificate or license number."},
    "P_VEHICLEID":     {"display": "Patient Vehicle Identifier",        "definition": "A vehicle identifier, such as a VIN or license plate number."},
    "P_DEVICEID":      {"display": "Patient Device Identifier",         "definition": "A device identifier or serial number."},
    "P_BIOMETRIC":     {"display": "Patient Biometric Identifier",      "definition": "A biometric identifier, such as a fingerprint or voiceprint."},
    "P_IPADDR":        {"display": "Patient IP Address",                "definition": "An Internet Protocol (IP) address."},
    "P_URL":           {"display": "Patient Web URL",                   "definition": "A Universal Resource Locator (URL)."},
    "P_FULLFACEPHOTO": {"display": "Patient Full Face Photo",           "definition": "A full-face photographic image."},
...
ALLOWED_SENSITIVITY_CODES = set(SENSITIVITY_CODES.keys()) | {""}
